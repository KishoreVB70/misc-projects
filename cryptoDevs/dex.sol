...
// Token contract Address -> 0x45dd7d32a81162dBdae57A50bA7D62aE3cfCB117
// DEX address -> 0xE3ee25Ea5891b559114BC8382D38E1c4e1E07b98

contract Exchange is ERC20 {

    address public cryptoDevTokenAddress;
    ERC20 cdToken = ERC20(cryptoDevTokenAddress);

    // Exchange is inheriting ERC20, because our exchange would keep track of Crypto Dev LP tokens
    constructor(address _CryptoDevtoken) ERC20("Liquidity Provider Token", "CDLP") {
    ...
    */
    function getReserve() public view returns (uint) {
        return cdToken.balanceOf(address(this));
    }
    ...
    function addLiquidity(uint _amount) public payable returns (uint) {
        ...
        */
        if(cryptoDevTokenReserve == 0) {
            // Transfer the `cdToken` address from the user's account to the contract
            ...
            //Ratio is the first amount the user pops in
            ...
            */
            ...
            // to the contract
            cdToken.transferFrom(msg.sender, address(this), cryptoDevTokenAmount);
    ...
    */
    function removeLiquidity(uint _amount) public returns (uint , uint) {
        ...
        cdToken.transfer(msg.sender, cryptoDevTokenAmount);
    ...
    */
    function ethToCryptoDevToken(uint _minTokens) public payable {
        uint256 cdReserve = getReserve();

        uint256 tokensToSend = getAmountOfTokens(
            msg.value,
            address(this).balance - msg.value,
            cdReserve
        );

        require(tokensToSend >= _minTokens, "insufficient output amount");
        // Transfer the `Crypto Dev` tokens to the user
        cdToken.transfer(msg.sender, tokensToSend);
    }
